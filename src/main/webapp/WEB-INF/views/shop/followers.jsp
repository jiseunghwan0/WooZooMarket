					...
					<table border="1"
						...
						<tr>
							...
							<c:if test="${msnum eq mem_storeNum }">
								<td bgcolor="#f2f2f2"><a class="tds"
									href="./favorites?mem_storeNum=${mem_storeNum}">찜&nbsp;&nbsp;
										${zico}</a></td>
							</c:if>
							<td bgcolor="#f2f2f2"><a class="tds"
							...
							<c:forEach items="${owelist}" var="vo">
								<div class="fst lis2"
									...
									<div style="text-align: center; margin-top: 20px;">
										<span class="span2"
											onclick="location.href='./myshop?mem_storeNum=${vo.give_storeNum }'">상품
											${vo.pco}</span>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;<span class="span2"
											onclick="location.href='./followers?mem_storeNum=${vo.give_storeNum }'">팔로워
											${vo.fco}</span><br>
									</div>
								</div>
							</c:forEach>
